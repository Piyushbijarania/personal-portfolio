      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="w-full flex flex-col gap-8">
          {cardData.slice(0, 4).map((card, index) => {
            const baseClassName = `card flex flex-col justify-between min-h-[260px] w-full p-10 rounded-[24px] border border-solid font-light overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] ${enableBorderGlow ? "card--border-glow" : ""}`;
            ...
            return (
              ...
              >
                ...
                <div className="card__content flex flex-col relative text-white">
                  <h3 className={`card__title font-semibold text-2xl m-0 mb-2`}>
                    {card.title}
                  </h3>
